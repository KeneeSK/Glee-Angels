                        ...
                        <tr
                          ...
                          className={`cursor-pointer transition-colors ${
                            isToday
                              ...
                              : item.highlight ? 'bg-gradient-to-r from-yellow-950/60 to-orange-950/30 border-l-4 animate-neon-pulse-gold' : 'hover:bg-zinc-800/40'
                          }`}
                        >
                          {/* Day Column */}
                          <td className="py-3.5 px-3 text-center align-middle">
                            <div className="flex flex-col items-center">
                              ...
                              <span className={`font-black font-mono text-sm ${
                                isToday ? 'text-cyan-400' : item.highlight ? 'animate-neon-text-gold' : 'text-zinc-300'
                              }`}>
                    ...
                    <button
                      ...
                      className={`shrink-0 flex flex-col items-center py-2 px-3 rounded-xl transition-all border ${
                        isSelected
                          ...
                          : item.highlight
                          ? 'bg-gradient-to-b from-yellow-900/60 to-orange-900/60 text-yellow-100 animate-neon-pulse-gold'
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border transition-all cursor-pointer ${
                      isToday
                        ...
                        : item.highlight
                        ? 'bg-gradient-to-r from-yellow-900/50 to-orange-900/30 z-10 animate-neon-pulse-gold'
